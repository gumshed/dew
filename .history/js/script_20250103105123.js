...
function displayContent(option) {
    ...
    switch (option) {
        case 'paper':
            content = `<h3>Paper</h3><p id="typewriter-text"></p>`;
            text = `Discover in-depth research, documents, and whitepapers detailing the intricacies of the Mind Control project.`;
            break;
        case 'ai':
            content = `<h3>AI</h3><p id="typewriter-text"></p>`;
            text = `Explore the role of artificial intelligence in modern mind control and predictive behavioral analysis.`;
            break;
        case 'slurpbots':
            content = `<h3>Slurpbots</h3><p id="typewriter-text"></p>`;
            text = `Learn about the autonomous trading bots designed to monitor and capitalize on opportunities in Raydium pools.`;
            break;
        case 'truth':
            content = `<h3>Truth</h3><p id="typewriter-text"></p>`;
            text = `Dive into whistleblower accounts and documented evidence of psychological operations and directed energy weapons.`;
            break;
        default:
            content = `<p id="typewriter-text">Select an option above to view more information.</p>`;
            text = '';
    }
    ...
    // Trigger the typewriter effect for the selected option
    if (text) {
