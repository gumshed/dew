    ...
    switch (option) {
        case 'paper':
            ...
            text = `
                ...
                Mind control, as a concept, has ancient roots...
        ...
        case 'ai':
            ...
            `;
            text = `
                Explore the role of artificial intelligence in modern mind control and predictive behavioral analysis.
            `;
            break;
        case 'slurpbots':
            content = `
            ...
            `;
            text = `
                Learn about the autonomous trading bots designed to monitor and capitalize on opportunities in Raydium pools.
            `;
            break;
        case 'truth':
            content = `
            ...
            `;
            text = `
                Dive into whistleblower accounts and documented evidence of psychological operations and directed energy weapons.
            `;
            break;
        default:
