...
function toggleFullscreenOverlay() {
    ...
    overlay.classList.toggle('hidden'); // Toggle the "hidden" class
    document.body.style.overflow = overlay.classList.contains('hidden') ? 'auto' : 'hidden'; // Prevent background scrolling
}
