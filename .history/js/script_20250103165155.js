...
function displayContent(option) {
    ...
    switch (option) {
        ...
        case 'slurpbots':
            ...
            text = `The Ultimate On-Chain Ally
            How Slurpbot Works: Combating On-Chain Madness

            Relentless Pool Surveillance:
            ...
            Dynamic Price Monitoring and Selling:
            ...
            Automated Reinvestment for Growth:
                Slurpbot reinvests a configurable percentage of the profits back into the pool or another base token like SOL, enabling compounding growth.
                The reinvestment process is seamless, leveraging real-time price data and user settings to maximize returns.
