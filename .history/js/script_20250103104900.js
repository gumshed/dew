...
function displayContent(option) {
    ...
    switch (option) {
        case 'paper':
            ...
            // Trigger the typewriter effect for Paper
            const text = `Discover in-depth research, documents, and whitepapers detailing the intricacies of the Mind Control project.`;
            typewriterEffect('typewriter-text', text);
            break;
        case 'ai':
            content = `
                <h3>AI</h3>
                <p>Explore the role of artificial intelligence in modern mind control and predictive behavioral analysis.</p>
            `;
            contentDisplay.innerHTML = content;
            break;
        case 'slurpbots':
            content = `
                <h3>Slurpbots</h3>
                <p>Learn about the autonomous trading bots designed to monitor and capitalize on opportunities in Raydium pools.</p>
            `;
            contentDisplay.innerHTML = content;
            break;
        case 'truth':
            content = `
                <h3>Truth</h3>
                <p>Dive into whistleblower accounts and documented evidence of psychological operations and directed energy weapons.</p>
            `;
            contentDisplay.innerHTML = content;
            break;
        default:
